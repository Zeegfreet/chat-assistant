...
export const DeleteCredentialForm: React.FC = () => {
    ...
    const handleConfirm = () => {
        dispatch(crudActions.delete(selectedItem["id"], "credentials"))
    }
    ...
    return (
        ...
        >
            <div>
                <Typoraphy>{t("credentials.messages.delete", { name: selectedItem ? selectedItem["name"] : null })}</Typoraphy>
